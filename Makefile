...
all: libancillary.a main.o SystemFunctions.o AttendRequest.o ParseRequest.o Resource.o RespondRequest.o WebServer.o
	gcc -Wall -std=c99 main.o SystemFunctions.o AttendRequest.o ParseRequest.o  Resource.o RespondRequest.o WebServer.o libancillary.a -o preforked-webserver 
...
main.o: main.c WebServer.h
	gcc -c -D_SVID_SOURCE -Wall -std=c99 main.c -o $@
